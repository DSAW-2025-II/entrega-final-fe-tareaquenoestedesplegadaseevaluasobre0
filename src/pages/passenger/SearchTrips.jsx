      ...
      <div style={{
        ...
        {showFilters && (
          <div style={{
            ...
            <div className="filters-actions" style={{ marginTop: '20px', display: 'flex', gap: '12px', justifyContent: 'flex-end', flexWrap: 'wrap' }}>
              <button
                type="button"
                onClick={clearFilters}
                style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                  <div style={{
                    ...
                    {selectedTrip.driver?.profilePhotoUrl ? (
                      <img
                        src={getImageUrl(selectedTrip.driver.profilePhotoUrl)}
                      ...
                      <span>{getInitials(selectedTrip.driver?.firstName, selectedTrip.driver?.lastName)}</span>
                    )}
                  </div>
                  <div style={{ flex: 1 }}>
