...
export default function Modal({ 
  ...
  return (
    ...
    >
      <div className={`bg-white rounded-2xl shadow-2xl ${sizes[size]} w-full max-w-[95vw] p-4 sm:p-6 animate-scale-in ${variantStyles[variant]}`}>
        {/* Header */}
        <div className="flex items-start justify-between mb-4 gap-2">
          <h3 className="text-lg sm:text-xl font-bold text-neutral-900 flex-1 break-words">
            {title}
          </h3>
          {!loading && (
            <button
